  ...
  return (
    <div>
        <Grid templateColumns='repeat(6, 1fr)' gap={3}
         paddingTop={"100px"} width={"81%"} margin={"auto"} marginBottom={"40px"}>
            <GridItem  h='70px' borderRadius={"10px"} border="1px solid gray" display={"flex"} justifyContent={"space-around"} 
                alignItems={"center"} fontSize={"20px"} fontWeight={"bold"}
                _hover={{
                    background: "gray.300",
                    cursor:"pointer"
                  }}>
            ...
            <GridItem  h='70px' borderRadius={"10px"} border="1px solid gray" display={"flex"} 
                alignItems={"center"} fontSize={"20px"} fontWeight={"bold"}
                _hover={{
                    background: "gray.300",
                    cursor:"pointer"
